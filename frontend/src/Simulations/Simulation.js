...
export default class LoginForm extends Component {
   ...
   // rellenar(){
    ...
    finish(){
        ...
        axios.get("http://localhost:8080/trainee/evaluacionLH/"+this.props.match.params.id+"/"+this.state.traineeId)
            ...
            .then(res => {
                ...
                .then(res => {
                 ...
                 doc.text(89, 60, `${this.state.heartRate} puls/min, ${this.state.breathingRate} resp/min,`)
                 doc.text(20, 65, `${this.state.sistolicPressure} mmHg, ${this.state.diastolicPressure} mmHg, ${this.state.saturation} SatO2`)
                 ...
                 doc.text(80,j,`Acciones  Global Alligment: ${this.state.GA}`)
                 j=j+10
                 doc.text(20,j,'Sección 2')
                 doc.text(20, j, '________')
                 j=j+10
                 doc.text(20,j,`Diagonal Score: ${this.state.Diag}%`)
                 doc.text(80,j,`Acciones  Global Alligment: ${this.state.GA}%`)
                 j=j+10
                 doc.text(20,j,'Sección 3')
                 doc.text(20, j, '________')
                 j=j+10
                 doc.text(20,j,`Recall: ${this.state.Recall}%`)
                 doc.text(80,j,`Accuracy: ${this.state.Accuracy}%`)
                 j=j+5
                 doc.text(20,j,`F1: ${this.state.F1}%`)
                 doc.text(80,j,`Precision: ${this.state.Precision}%`)
                 j=j+5
                 doc.text(20,j,`Specificity: ${this.state.Specificity}%`)
      ...
      j=j+5
      doc.text(20,j,`Acciones  contrarias: ${this.state.contr}`)
      doc.text(80,j,`Global Alligment: ${this.state.GA}`)
      j=j+10
      doc.text(20,j,'Sección 2')
      doc.text(20, j, '________')
      j=j+10
      doc.text(20,j,`Diagonal Score: ${this.state.Diag}%`)
      doc.text(80,j,`Subsecuence Score:: ${this.state.GA}%`)
      j=j+10
      doc.text(20,j,'Sección 3')
      doc.text(20, j, '________')
      j=j+10
