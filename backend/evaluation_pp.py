...
Original file is located at
    https://colab.research.google.com/drive/1eyBf_k4L0GYX0_ZC4LkXc0fBCCEL7xCX
"""
...
AccPelvis1P=[7,30,29,19,25,129,35,50,52,53,51,54,12,42,8,130,78,70,69,67,65,66,68,71] # acciones que debería haber hecho en los primeros 4 min
AccPelvis2P=[32,30,29,19,25,129,35,50,52,53,51,54,12,42,8,130,78,70,69,67,65,66,68,71] # acciones que debería haber hecho en los primeros 4 min
AccPelvis3P=[37,30,29,19,25,129,35,50,52,53,51,54,12,42,8,130,78,70,69,67,65,66,68,71] # acciones que debería haber hecho en los primeros 4 min
AccPelvis4P=[50,52,53,51,54,7,30,29,19,25,129,35,70,69,67,65,66,68,71,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
AccPelvis5P=[50,52,53,51,54,32,30,29,19,25,129,35,70,69,67,65,66,68,71,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
AccPelvis6P=[50,52,53,51,54,37,30,29,19,25,129,35,70,69,67,65,66,68,71,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
AccPelvis7P=[7,30,35,19,25,129,29,50,52,53,51,54,12,42,8,130,78,70,69,67,65,66,68,71] # acciones que debería haber hecho en los primeros 4 min
AccPelvis8P=[32,30,35,19,25,129,29,50,52,53,51,54,12,42,8,130,78,70,69,67,65,66,68,71] # acciones que debería haber hecho en los primeros 4 min
AccPelvis9P=[37,30,35,19,25,129,29,50,52,53,51,54,12,42,8,130,78,70,69,67,65,66,68,71] # acciones que debería haber hecho en los primeros 4 min
AccPelvis10P=[50,52,53,51,54,7,30,35,19,25,129,29,70,69,67,65,66,68,71,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
AccPelvis11P=[50,52,53,51,54,32,30,35,19,25,129,29,70,69,67,65,66,68,71,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
AccPelvis12P=[50,52,53,51,54,37,30,35,19,25,129,29,70,69,67,65,66,68,71,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
AccPelvis13P=[7,30,29,19,50,52,51,12,42,8,130,78,70,69,67,65] # acciones que debería haber hecho en los primeros 4 min
AccPelvis14P=[32,30,29,19,50,52,51,12,42,8,130,78,70,69,67,65] # acciones que debería haber hecho en los primeros 4 min
AccPelvis15P=[37,30,29,19,50,52,51,12,42,8,130,78,70,69,67,65] # acciones que debería haber hecho en los primeros 4 min
AccPelvis16P=[50,52,51,7,30,29,19,70,69,67,65,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
AccPelvis17P=[50,52,51,32,30,29,19,70,69,67,65,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
AccPelvis18P=[50,52,51,37,30,29,19,70,69,67,65,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
AccPelvis19P=[7,30,19,29,50,52,51,12,42,8,130,78,70,69,67,65] # acciones que debería haber hecho en los primeros 4 min
AccPelvis20P=[32,30,19,29,50,52,51,12,42,8,130,78,70,69,67,65] # acciones que debería haber hecho en los primeros 4 min
AccPelvis21P=[37,30,19,29,50,52,51,12,42,8,130,78,70,69,67,65] # acciones que debería haber hecho en los primeros 4 min
AccPelvis22P=[50,52,51,7,30,19,29,70,69,67,65,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
AccPelvis23P=[50,52,51,32,30,19,29,70,69,67,65,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
AccPelvis24P=[50,52,51,37,30,19,29,70,69,67,65,12,42,8,130,78] # acciones que debería haber hecho en los primeros 4 min
lista_esc_Pelvis_P=[AccPelvis1P,AccPelvis2P,AccPelvis3P,AccPelvis4P,AccPelvis5P,AccPelvis6P,AccPelvis7P,AccPelvis8P,
                    AccPelvis9P,AccPelvis10P,AccPelvis11P,AccPelvis12P,AccPelvis13P,AccPelvis14P,AccPelvis15P,
                    AccPelvis16P,AccPelvis17P,AccPelvis18P,AccPelvis19P,AccPelvis20P,AccPelvis21P,
                    AccPelvis22P,AccPelvis23P,AccPelvis24P]

#Trainee_Pelvis_Sim_Actions=[7,28,42,16,132,63,53,52]
lista_aciertos=[]
for esc in lista_esc_Pelvis_P:
...
escenario_select=lista_esc_Pelvis_P[np.argmax(lista_aciertos)]
...
#print('Diagonal:'+str(SimilarDiagonalScore))
